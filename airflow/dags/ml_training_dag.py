...
dag = DAG(
    ...
    description='Train demand forecasting ML model weekly',
    schedule_interval='0 2 * * 0',  # Every Sunday at 2 AM
    catchup=False,
    tags=['ml', 'training', 'forecasting']
)

# Task 1: Train demand forecast model
...
# Task 2: Generate predictions after training
...
# Task 3: Import predictions to ClickHouse
